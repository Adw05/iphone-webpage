...
const VideoCarousel = () => {
  ...
  const handleLoadedMetadata = (i,e) => setLoadData((pre)=>[...pre,e])
  useEffect(()=>{
          ...
          <div key={list.id} id="slider" className='sm:pr-20 pr-10'>
            <div className="video-carousel_container">
              <div className='w-full h-full flex-center rounded-3xl overflow-hidden bg-black'>
                <video
                id="video" playsInline={true} preload='auto' muted ref={(el)=> (videoRef.current[i]=el)} onPlay={()=>(
                  setVideo((prevVideo)=>({
        ...
        {videoRef.current.map((_,i)=>(
          <span
           ...
           >
            ...
            results={(el)=>(videoSpanRef.current[i]=el)}>
